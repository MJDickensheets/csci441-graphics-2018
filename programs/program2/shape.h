...
public:
	...
	// do flat shading
	    ...
	    normals.resize(verticies.size(), Vector(0.0, 0.0, 0.0));
	       ...
	       add_vertex(coords, verticies[ia].x(), verticies[ia].y(), verticies[ia].z(), r, g, b, normal);
	       add_vertex(coords, verticies[ib].x(), verticies[ib].y(), verticies[ib].z(), r, g, b, normal);
	       add_vertex(coords, verticies[ic].x(), verticies[ic].y(), verticies[ic].z(), r, g, b, normal);
	...
	// do smooth shading
	    ...
	    for(int i = 0; i < elements.size(); i+=3){
	       ...
	       GLushort ib = elements[i+1];
	       GLushort ic = elements[i+2];
	       add_vertex(coords, verticies[ia].x(), verticies[ia].y(), verticies[ia].z(), r, g, b, vert_norms[ia]);
	       add_vertex(coords, verticies[ib].x(), verticies[ib].y(), verticies[ib].z(), r, g, b, vert_norms[ib]);
	       add_vertex(coords, verticies[ic].x(), verticies[ic].y(), verticies[ic].z(), r, g, b, vert_norms[ic]);
